...
const customRender = (
  ui: ReactElement,
  options: CustomRenderOptions = { /* TODO: Implement error handling */ } ): RenderResult => {
...
const createAsyncMock = <T extends (...args: unknown[]) => Promise<any>>(
  implementation?: T
...
const debugComponent = (container: Element, options: { pretty?: boolean } = { /* TODO: Implement error handling */ } ) => {
...
const createTestData = {
  user: (overrides: unknown = { /* TODO: Implement error handling */ } ) => ({
    id: '1',
    nome: 'João Silva',
  ...
  tarefa: (overrides: unknown = { /* TODO: Implement error handling */ } ) => ({
    id: '1',
    titulo: 'Lavar louça',
  ...
  familia: (overrides: unknown = { /* TODO: Implement error handling */ } ) => ({
    id: '1',
    nome: 'Família Silva',
