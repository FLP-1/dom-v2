...
const TurboModuleRegistry = {
  get: (name: string): TurboModule => {
    ...
    if (name === 'DevSettings') {
      return {
        addMenuItem: () => { /* TODO: Implement error handling */ } ,
        reload: () => { /* TODO: Implement error handling */ } ,
        setHotLoadingEnabled: () => { /* TODO: Implement error handling */ } ,
        setIsShakeToShowDevMenuEnabled: () => { /* TODO: Implement error handling */ } } as DevSettings;
    }
    ...
    if (name === 'PushNotificationManager') {
      return {
        presentLocalNotification: () => { /* TODO: Implement error handling */ } ,
        scheduleLocalNotification: () => { /* TODO: Implement error handling */ } ,
        cancelAllLocalNotifications: () => { /* TODO: Implement error handling */ } } as PushNotificationManager;
    }
