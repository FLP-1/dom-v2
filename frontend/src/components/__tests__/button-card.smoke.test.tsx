...
describe('Button/Card (smoke)', () => {
  it('renderiza Button', () => {
    const { toJSON } = render(<Button title="OK" onPress={() => { /* TODO: Implement error handling */ } } /> as any);
    expect(toJSON()).toBeTruthy();
  });
  it('renderiza Card', () => {
    const { toJSON } = render(<Card title="T" subtitle="S" /> as any);
    expect(toJSON()).toBeTruthy();
  });
});
