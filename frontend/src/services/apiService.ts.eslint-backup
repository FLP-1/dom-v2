...
export class ApiService {
  ...
  async getPaymentStats(): Promise<{
    ...
    return this.request<{ stats: any }>('/payments/stats/summary')
...
export const DataConverters = {
  ...
  async updatePayrollConfig(config: any): Promise<any> {
  ...
  async createESocialCertificate(certificateData: any): Promise<any> {
  ...
  async updateESocialConfig(configData: any): Promise<any> {
  ...
  async createESocialEvent(eventData: any): Promise<any> {
