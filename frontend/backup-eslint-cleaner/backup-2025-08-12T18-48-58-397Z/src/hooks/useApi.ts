...
export function useApi<T = any>(
  endpoint: string,
  options: ApiOptions = { /* TODO: Implement error handling */ } ): ApiResponse<T> {
  const {
    immediate = true,
    cache = true,
...
export function useApiPost<T = any, R = any>(
  endpoint: string,
  options: ApiOptions = { /* TODO: Implement error handling */ } ): ApiResponse<R> & { post: (data: T) => Promise<void> } {
...
export function useApiPut<T = any, R = any>(
  endpoint: string,
  options: ApiOptions = { /* TODO: Implement error handling */ } ): ApiResponse<R> & { put: (data: T) => Promise<void> } {
  const [state, setState] = useState<ApiState<R>>({
    data: null,
    loading: false,
    error: null,
...
export function useApiDelete<R = any>(
  endpoint: string,
  options: ApiOptions = { /* TODO: Implement error handling */ } ): ApiResponse<R> & { delete: () => Promise<void> } {
  const [state, setState] = useState<ApiState<R>>({
    data: null,
    loading: false,
    error: null,
