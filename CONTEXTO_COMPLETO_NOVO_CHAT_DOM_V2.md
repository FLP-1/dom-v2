...
backend/
├── src/
│   ├── controllers/     # 12 arquivos (100% qualidade)
│   ├── routes/          # 12 arquivos (100% qualidade)
│   ├── models/          # 3 arquivos (100% qualidade)
│   ├── middleware/      # 1 arquivo (100% qualidade)
│   ├── utils/           # 1 arquivo (100% qualidade)
│   └── generated/       # 20 arquivos (qualidade variável)
├── prisma/
...
- **Problema:** Qualidade caiu de 100% para 86.3%
- **Causa:** Novos arquivos sem aplicar diretivas críticas
...
## 🛠️ **COMANDOS NPM PRINCIPAIS**

### **CORREÇÃO E VALIDAÇÃO:**
```bash
# Diretório: C:\dom-v2
npm run aggressive-fix              # Correção agressiva de qualidade
npm run validate-directives         # Validar diretivas críticas
npm run fix-critical               # Corrigir issues críticos
npm run setup-hooks               # Configurar validação automática
```

### **FASES DO PROJETO:**
```bash
# Diretório: C:\dom-v2
npm run phase3-benchmark           # Benchmark da Fase 3
