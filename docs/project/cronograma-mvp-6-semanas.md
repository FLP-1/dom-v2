...
- Backend: APIs de ponto (batida/registros) – CONCLUÍDO (dev, file-store)
- Backend: APIs de funcionários (CRUD) – CONCLUÍDO (dev, file-store)
- Web: tela de Ponto integrada ao dashboard – CONCLUÍDO
- Web: tela de Funcionários (lista/CRUD simples) – CONCLUÍDO
- RBAC refinado por ação (permissões granulares) – CONCLUÍDO (Finanças, Funcionários, Ponto)
