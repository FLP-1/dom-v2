# Script de Execução DOM v2 - Web Simples
# Data: 23/07/2025
# Regra: Simplicidade extrema

Write-Host "=== EXECUCAO DOM v2 - WEB SIMPLES ===" -ForegroundColor Green
...
Write-Host "Aguardando 10 segundos para Metro inicializar..." -ForegroundColor Yellow
Start-Sleep -Seconds 10

Write-Host "`nIniciando Servidor Web..." -ForegroundColor Cyan
