...
const initializeDatabase = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield Promise.race([queryPromise, queryTimeoutPromise]);
...
app.post('/api/auth/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const user = yield Promise.race([userPromise, userTimeoutPromise]);
        ...
        if (!user) {
            ...
            let group = yield prisma.groups.findFirst({
                where: { tipo: 'user' }
            });
            if (!group) {
                console.log('👥 Criando grupo básico...');
                group = yield prisma.groups.create({
                    data: {
                        nome: 'Usuário Básico',
            ...
            yield prisma.user_group_roles.create({
                data: {
                    user_id: newUser.id,
                    group_id: group.id,
                    role: 'user',
