...
/**
 * Servidor Dashboard - DOM v2
 * Servidor específico para funcionalidades do dashboard
 */
...
// Rotas de documentos com autenticação
app.get('/api/documents/categories/list', authenticateToken, async (req, res) => {
  try {
...
// Iniciar servidor
app.listen(PORT, () => {
  console.log(`🚀 Servidor Dashboard DOM v2 rodando na porta ${PORT}`);
  ...
  console.log(`   - GET /api/documents/categories/list (auth)`);
  console.log(`   - GET /api/documents/stats (auth)`);
